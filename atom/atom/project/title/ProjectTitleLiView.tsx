 ...
 * @param period 프로젝트 기간
 * @constructor
 */
function ProjectTitleLiView ({title  , checked , liOnClick , period}: ProjectTitleLiViewPropsInterface) : React.JSX.Element {
    return (
        <ProjectTitleLiStyle
            id={`${title}_project`}
            $checked={checked}
        ...
        >
            ...
            `} />
            <PTag font={RussoOneFont.className} content={period} $styles={css`
              ${ContentFontSizePC};
              ${(props) => props.theme.media.tablet} {
